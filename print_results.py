...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary for CNN Model Architecture",model.upper(), 
          "***")
    print("{:20}: {:30}".format('N Images', results_stats_dic['n_images']))
    print("{:20}: {:30}".format('N Dog Images', results_stats_dic['n_dogs_img']))
    ...
    #          results_stats_dic
    #
    print("{:20}: {:30}".format('N NotDog Images', results_stats_dic['n_notdogs_img']))
    ...
    for key in results_stats_dic:
        ...
        #
        if key[0]=='p':
            print("\n{:20}: {:30}".format(key, results_stats_dic[key]))
